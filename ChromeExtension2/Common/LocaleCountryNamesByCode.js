...
{ let temp = StrArray('CountryNames', LocaleCountryNamesByCode); /*asort(temp);*/ return temp; }
...
{ let temp = StrArray('RegionCANames', LocaleRegionCANamesByCode); /*asort(temp);*/ return temp; }
...
{ let temp = StrArray('RegionUSNames', LocaleRegionUSNamesByCode); /*asort(temp);*/ return temp; }
...
function LocaleRegionNamesByCode(countryCode)
{
   switch (countryCode)
   {
      case 'CA': return LocaleRegionCANamesByCode();
      case 'US': return LocaleRegionUSNamesByCode();
      default:
